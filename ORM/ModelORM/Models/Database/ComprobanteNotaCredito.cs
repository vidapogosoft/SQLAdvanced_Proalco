...
{
    public partial class ComprobanteNotaCredito
    {
        public int IdComprobanteNotaCredito { get; set; }
        ...
        public string XmlComprobanteNotaCredito { get; set; } = null!;
        public string? XmlComprobanteNotaCreditoAutorizado { get; set; }
