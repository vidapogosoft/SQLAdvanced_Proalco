...
{
    public partial class ComprobanteNotaDebito
    {
        public int IdComprobanteNotaDebito { get; set; }
        ...
        public string XmlComprobanteNotaDebito { get; set; } = null!;
        public string? XmlComprobanteNotaDebitoAutorizado { get; set; }
